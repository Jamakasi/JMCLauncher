  ...
  private JScrollPane getUpdateNews()
  {
    ...
    try
    {
      ...
      new Thread() {
        public void run() {
          try {
    		  editorPane.setPage(new URL(Config.NewsURL));
          } catch (Exception e) {
            e.printStackTrace();
...
JComboBox comboBoxServer = new JComboBox(Config.itemsServers);
...
comboBoxServer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            Config.CurrentServer = temp.getSelectedIndex();    
                        }
});
////////////////    
      ...
      else
      {
        ...
        accountLink.addMouseListener(new MouseAdapter() {
          public void mousePressed(MouseEvent arg0) {
            try {
              Util.openLink(new URL(Config.RegURL).toURI());
            } catch (Exception e) {
              e.printStackTrace();
            }
          }
  ...
  private TransparentLabel getUpdateLink() {
    ...
    accountLink.addMouseListener(new MouseAdapter() {
      public void mousePressed(MouseEvent arg0) {
        try {
          Util.openLink(new URL(Config.LDwlURL).toURI());
        } catch (Exception e) {
          e.printStackTrace();
        }
      }
